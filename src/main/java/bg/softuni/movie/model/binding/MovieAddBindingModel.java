...
public class MovieAddBindingModel {
    ...
    public MovieAddBindingModel setTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public MovieAddBindingModel setGenre(List<GenreEnum> genre) {
        this.genre = genre;
        return this;
    }
    ...
    public MovieAddBindingModel setDistributor(String distributor) {
    ...
    public MovieAddBindingModel setCast(String cast) {
        this.cast = cast;
        return this;
    }
    ...
    public MovieAddBindingModel setTrailerUrl(String trailerUrl) {
    ...
    public MovieAddBindingModel setCountry(CountryEntity country) {
    ...
    public MovieAddBindingModel setAddedOn(LocalDate addedOn) {
